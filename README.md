...
## Install
    ...
    go get github.com/ddebrunner/jsonata-go
...
import (
	...
	jsonata "github.com/ddebrunner/jsonata-go"
)
...
for testing is [available here](https://github.com/ddebrunner/jsonata-go/jsonata-server).
